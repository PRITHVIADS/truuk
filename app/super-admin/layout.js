"use client";
import{useState}from"react";import{useSession}from"next-auth/react";import{useRouter}from"next/navigation";import{useEffect}from"react";import{Sidebar,MobileHeader}from"@/components/layout/Sidebar";
export default function L({children}){
  ...
  return(
    <div className="min-h-screen flex">
      <Sidebar open={o} setOpen={s}/>
      <div className="flex-1 md:ml-64 flex flex-col min-h-screen">
        <MobileHeader setOpen={s}/>
